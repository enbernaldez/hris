<div class="container-fluid">
    ...
    <div class="row mt-5">
        <div class="col mx-1">
            ...
            <input type="text" required name="spouse_name_last" id="spouse_name_last" class="form-control uppercase group-na">
        </div>
        <div class="col mx-1">
            <label for="spouse_name_first">FIRST NAME</label><br>
            <input type="text" required name="spouse_name_first" id="spouse_name_first" class="form-control uppercase group-na">
        </div>
        <div class="col mx-1">
        ...
        <div class="col-2 mx-1">
            ...
            <div class="checkbox-container">
                <input type="text" required name="spouse_name_ext" id="spouse_name_ext" class="form-control uppercase group-na">
                <div class="form-check ms-2">
    ...
    <div class="row mt-3">
        ...
        <div class="col mx-1">
            ...
            <div class="checkbox-container">
                <input type="text" required name="spouse_bus_name" id="spouse_bus_name" class="form-control uppercase group-na">
                <div class="form-check ms-2">
        ...
        <div class="col mx-1">
            ...
            <div class="checkbox-container">
                <input type="text" required name="spouse_bus_add" id="spouse_bus_add" class="form-control uppercase group-na">
                <div class="form-check ms-2">
        ...
        <div class="col mx-1">
            ...
            <div class="checkbox-container">
                <input type="text" required name="spouse_telno" id="spouse_telno" class="form-control uppercase group-na">
                <div class="form-check ms-2">
    ...
    <div class="row mt-3">
        <div class="col mx-1">
            ...
            <input type="text" required name="father_name_last" id="father_name_last" class="form-control uppercase group-na">

        </div>
        <div class="col mx-1">
            <label for="father_name_first">FIRST NAME</label><br>
            <input type="text" required name="father_name_first" id="father_name_first" class="form-control uppercase group-na">
        </div>
        <div class="col mx-1">
        ...
        <div class="col-2 mx-1">
            ...
            <div class="checkbox-container">
                <input type="text" required name="father_name_ext" id="father_name_ext" class="form-control uppercase group-na">
                <div class="form-check ms-2">
    ...
    <div class="row mt-3">
        <div class="col mx-1">
            ...
            <input type="text" required name="mother_name_last" id="mother_name_last" class="form-control uppercase group-na">

        </div>
        <div class="col mx-1">
            <label for="mother_name_first">FIRST NAME</label><br>
            <input type="text" required name="mother_name_first" id="mother_name_first" class="form-control uppercase group-na">
        </div>
        <div class="col mx-1">
    ...
    <div class="row-container">
        ...
        <div class="row row-row mb-3">
            <div class="col-8 mx-1">
                <input type="text" required name="child_fullname[]" id="child_name" class="form-control uppercase group-na">
            </div>
            <div class="col mx-1">
                <div class="checkbox-container">
                    <input type="date" required name="child_birthdate[]" id="child_dob" class="form-control uppercase group-na">
