    ...
    <div class="row mt-5">
        <div class="col-4">
            ...
            <div class="skills-container">
                <div class="input-group mb-2">
                    <input class="form-check-input me-2" type="checkbox" id="skills_na" onclick="checkNA('skills')"
                        required>
                    <label class="form-check-label me-2" for="skills_na">N/A</label>
                    <input type="text" name="skills[]" class="form-control" required>
                </div>
            </div>
            <button type="button" class="btn btn-primary add-row-button float-end" onclick="addInput('skills')">ADD
                ROW</button>
        </div>
        <div class="col-4">
        ...
        <div class="col-4">
            ...
            <div class="members-container">
                <div class="input-group mb-2">
                    <input class="form-check-input me-2" type="checkbox" id="members_na" onclick="checkNA('members')"
                        required>
                    <label class="form-check-label me-2" for="members_na">N/A</label>
                    <input type="text" name="members[]" class="form-control" required>
                </div>
            </div>
            <button type="button" class="btn btn-primary add-row-button float-end" onclick="addInput('members')">ADD
                ROW</button>
        </div>
    </div>
    <!-- QUESTIONS -->
    <div class="row mt-3">
        <div class="col-12">
            ...
            <div>
                ...
                <div>
                    &emsp;<input type="radio" id="radio_consanguinity1" name="radio_consanguinity" value="yes" required>
                    Yes
                </div>
                <div>
                    &emsp;<input type="radio" id="radio_consanguinity" name="radio_consanguinity" value="no" required>
                    No
                </div>
            </div>
            <div>
            ...
            <div class="col-12">
                <div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <input type="text" id="input_guilty" name="input_guilty" class="form-control" required
                                disabled>
                        </div>
                    </div>
                ...
                <div>
                    <div class="col-12">
                        <div>
                            ...
                            <div>
                                &emsp;<input type="radio" id="radio_candidate1" name="radio_candidate" value="yes"> Yes
                            </div>
                            <div>
                                &emsp;<input type="radio" id="radio_candidate" name="radio_candidate" value="no"> No
                            </div>
                        </div>
                        <div>
                            ...
                            <div>
                                &emsp;<input type="radio" id="radio_resigned1" name="radio_resigned" value="yes"> Yes
                            </div>
                            <div>
                                &emsp;<input type="radio" id="radio_resigned" name="radio_resigned" value="no">
                                No
                            </div>
                            <div class="row">
                                <div class="col-3">
                                ...
                                <div class="col-4">
                                    <input type="text" id="input_resigned" name="input_resigned" class="form-control"
                                        required disabled>
                                </div>
                            </div>
                            <hr>
                    ...
                    <div class="col-12">
                        <p>Have you acquired the status of an immigrant or permanent resident of
                            another country?</p>
                        <div>
                            &emsp;<input type="radio" id="radio_immigrant1" name="radio_immigrant" value="yes">
                            Yes
                        </div>
                        <div>
                            &emsp;<input type="radio" id="radio_immigrant" name="radio_immigrant" value="no"> No
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-3">
                    ...
                    <div class="col-12">
                        <div>
                            ...
                            <div>
                                &emsp;<input type="radio" id="radio_indigenous1" name="radio_indigenous" value="yes">
                                Yes
                            </div>
                            <div>
                                &emsp;<input type="radio" id="radio_indigenous" name="radio_indigenous" value="no"> No
                            </div>
                            <div class="row">
                                <div class="col-3">
                            ...
                            <div>
                                ...
                                <div>
                                    &emsp;<input type="radio" id="radio_disability" name="radio_disability" value="no">
                                    No
                                </div>
                                <div class="row">
                                    <div class="col-3">
                            ...
                            <div>
                                ...
                                <div>
                                    &emsp;<input type="radio" id="radio_solo1" name="radio_solo" value="yes">
                                    Yes
                                </div>
                                <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <input type="text" id="input_solo" name="input_solo" class="form-control"
                                            required disabled>
                                    </div>
