<div class="container-fluid">
    ...
    <div class="row mt-3">
        <div class="col mx-2">
            ...
            <input type="number" required name="height" id="height" class="form-control" min="1" step="0.01" max="2">
        </div>
        <div class="col mx-2">
    ...
    <div class="row mt-3">
        ...
        <div class="col mx-2">
            ...
            <select id="radd_citymunicipality" required name="radd_citymunicipality" class="form-select">
                <?php
        ...
        <div class="col mx-2">
            ...
            <input type="text" required name="radd_barangay" id="radd_barangay" class="form-control">
        </div>
    </div>
    ...
    <div class="row mt-3">
        ...
        <div class="col mx-2">
            ...
            <div class="checkbox-container">
                <input type="text" required name="radd_street" id="radd_street" class="form-control">
                <div class="form-check ms-2">
        ...
        <div class="col mx-2">
            ...
            <div class="checkbox-container">
                <input type="text" required name="radd_houseblocklot" id="radd_houseblocklot" class="form-control">
                <div class="form-check ms-2">
    ...
    <div class="row mt-3">
        <div class="col-3 mx-2">
            ...
            <input type="number" required name="radd_zipcode" id="radd_zipcode" class="form-control" min="400"
                max="9900">
        </div>
    </div>
    ...
    <div class="row mt-3">
        ...
        <div class="col mx-2">
            ...
            <select id="padd_citymunicipality" required name="padd_citymunicipality" class="form-select">
                <?php
                $list_citymunicipality = query($conn, "SELECT * FROM `city_municipality`");
                echo '<option value="" disabled selected value>--select--</option>';
                foreach ($list_citymunicipality as $key => $row) {
        ...
        <div class="col mx-2">
            ...
            <input type="text" required name="padd_barangay" id="padd_barangay" class="form-control">
        </div>
    </div>
    ...
    <div class="row mt-3">
        ...
        <div class="col mx-2">
            ...
            <div class="checkbox-container">
                <input type="text" required name="padd_street" id="padd_street" class="form-control">
                <div class="form-check ms-2">
        ...
        <div class="col mx-2">
            ...
            <div class="checkbox-container">
                <input type="text" required name="padd_houseblocklot" id="padd_houseblocklot" class="form-control">
                <div class="form-check ms-2">
    ...
    <div class="row mt-3">
        <div class="col-3 mx-2">
            ...
            <input type="number" required name="padd_zipcode" id="padd_zipcode" class="form-control" min="400"
                max="9900">
        </div>
    </div>
