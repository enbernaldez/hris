        ...
        <script>
            ...
            chk_same.addEventListener('change', function () {
                ...
                sourceInputs.forEach((source, index) => {
                    copyValues(source, destinationInputs[index], chk_same.checked, naCheckboxes[index]);
                });
            });
            ...
            $(document).ready(function () {
                $('#radd_province').change(function () {
                    ...
                    if (provinceName) {
                        ...
                        $('#radd_citymunicipality').html('<option value="" disabled selected value>--select--</option>');
                    }
                });
            });
        </script>
