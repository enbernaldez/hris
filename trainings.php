        ...
        <div class="row mt-5">
          ...
          <div class="col-4">
            <div class="input-group rounded">
              <input type="search" name="search_input" class="form-control search-box" placeholder="Search..."
                aria-label="Search" aria-describedby="search-trainings">
          ...
          <div class="modal-body px-4">
            <form action="trainings_new.php" method="POST">
              ...
              <div class="row mx-0 my-3">
                <button type="button" class="btn btn-primary add-row-button mt-1 float-start" style="width:100px"
                  onclick="addInput()">
                  ADD ROW
                </button>
              </div>
              ...
              <div class="my-3">
                <label for="inclusiveDatesOfattedance" class="form-label">Inclusive Dates of Attendance</label><br>
                <div class="row">
                  <div class="col-6">
                    <label for="from" class="form-label">FROM:</label>
                    <input type="date" required name="date_from[]" id="date_from" class="form-control">
                  </div>
                  <div class="col-6">
