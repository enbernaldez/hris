            ...
            <div class="col-10">
                ...
                <div class="row mt-3 ms-1">
                    <div class="col-1 text-center d-flex align-items-center justify-content-center">VOCATIONAL/ TRADE
                        COURSE
                        <input type="checkbox" class="not_app mb-3 pb-3" id="null_vocational">
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            plusIcons.forEach(function (icon) {
                ...
                icon.addEventListener("click", function () {
                    ...
                    //Find the checkbox for deletion in the cloned row and enable it 
                    const deletionCheckbox = clonedRow.querySelector(".delete-row-checkbox");
                    if (deletionCheckbox) {
                        deletionCheckbox.checked = false; //Ensure it's unchecked for the new row 
                        deletionCheckbox.disabled = false; //Enable the checkbox
                    }
                });
            });
        });
